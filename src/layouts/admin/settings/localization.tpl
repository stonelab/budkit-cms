            ...
            <form class="form-vertical col-md-12 col-sm-12 col-lg-8" method="POST" action="/settings/system/save">
                <fieldset class="no-margin">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select name="options[localization][timezone]" class="form-control" value="config|localization.timezone">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select name="options[localization][locale]" class="form-control" data="config|localization.locale">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select name="options[localization][date-format]" class="form-control" data="config|localization.date-format">
