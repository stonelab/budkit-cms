                ...
                <div class="login-form">
                    <form action="/member/signup" method="post">
                        <div class="form-group">
                            <input type="text" name="user_first_name" class="form-control login-field" value="" placeholder="First name" id="login-name"/>
                            <label class="login-field-icon fui-user" for="login-name"></label>
                        </div>

                        <div class="form-group">
                            <input type="text" name="user_last_name" class="form-control login-field" value="" placeholder="Last name" id="login-name"/>
                            <label class="login-field-icon fui-user" for="login-name"></label>
                        </div>

                        <div class="form-group">
                            <input type="text" name="user_name_id" class="form-control login-field" value="" placeholder="Username" id="login-name"/>
                            <label class="login-field-icon fui-link" for="login-name"></label>
                        </div>

                        <div class="form-group">
                            <input type="email" name="user_email" class="form-control login-field" value="" placeholder="Email" id="login-name"/>
                        ...
                        <div class="form-group">
                            <input type="password" name="user_password_2" class="form-control login-field" value="" placeholder="Verify Password" id="login-pass"/>
                            <label class="login-field-icon fui-lock" for="login-pass"></label>
                        </div>

                        <button type="submit" class="btn btn-primary btn-embossed btn-lg btn-block">Create Account</button>
